...
const RegisterModal = ({ isOpen, onClose, onSubmit }) => {
    ...
    return (
      ...
      >
        ...
        <input className="modal__input modal__input_type_text" type="text" value={values.name} onChange={handleChange} placeholder="Name" />
        ...
        <label className="modal__label">name</label>
        <input className="modal__input modal__input_type_text" type="url" value={values.AvatarUrl} onChange={handleChange} placeholder="Avatar Url" />
